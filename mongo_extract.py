...
if mongo_client is None: 
    ...
    print("mongodb connection established Andy")
...
event_docs = mongo_collection.find(mongo_query, 
batch_size = 3000)


# A blank list to store the results 
all_events = []
...
for doc in event_docs:
    ...
    #adding the event to the final list of events
...
#load the aws_bot_credentials values
parser = configparser.ConfigParser()
parser.read("pipeline.conf")
